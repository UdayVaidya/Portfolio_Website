...
const socialLinks = [
    ...
    {
        href: "https://www.instagram.com/_uday_vaidya", alt: "Instagram",
    ...
    {
        href: "https://x.com/uday_vaidya_", alt: "X / Twitter",
        ...
        <section id="home" className="relative overflow-hidden py-24 px-[5%] flex flex-col" style={{ height: '100dvh' }}>
            ...
            >
                ...
                <motion.p
                    ...
                    className="text-4xl sm:text-5xl lg:text-8xl md:text-6xl font-extrabold mb-4 text-arc-orange uppercase font-mono"
                >
                    Hi, my name is
                </motion.p>
                ...
                <motion.h1
                    className="text-4xl sm:text-5xl lg:text-8xl md:text-6xl font-extrabold uppercase font-mono mb-4 flex flex-wrap"
            ...
            <motion.div
                className="flex flex-row justify-center md:justify-center lg:justify-start md:gap-10 gap-5 mt-5 pt-5"
            ...
            >
                {socialLinks.map(({ href, alt, svg }) => (
                    <motion.a
                        ...
                        className="opacity-65 w-12 h-12"
                    >
                        {svg}
                    </motion.a>
                ))}
            ...
            >
                {/* Mobile/tablet pill card */}
                <div className="flex lg:hidden flex-row rounded-2xl overflow-hidden"
                ...
                {/* Desktop vertical list — only on lg+ */}
